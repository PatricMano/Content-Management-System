...
<body>
  ...
  <main id="main">
    <!--removed all content before Our team section-->
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          //SQL query that fetches required info from groups tables
          $query = "SELECT GroupName, GroupType, GroupDesc, GroupImage FROM groups";
